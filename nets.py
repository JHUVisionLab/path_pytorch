...
def resnet50_train_tiling(num_classes=4, num_res = 3, pool_after = False):
  model = resnet50_tiling_1fc(pretrained=True, pool_after = pool_after, num_classes = 4, num_res = num_res)
  return model
