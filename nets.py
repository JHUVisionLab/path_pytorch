...
def resnet50_train_tiling(num_classes=4, res = [0,1,2], pool_after = False):
  model = resnet50_tiling_1fc(pretrained=True, pool_after = pool_after, num_classes = 4, res = res)
  return model
